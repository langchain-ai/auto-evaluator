...
var _routeModuleLoader = require("../server/future/helpers/module-loader/route-module-loader");
var _nextRequest = require("../server/web/spec-extension/adapters/next-request");
                ...
                if (isRouteHandler) {
                    ...
                    try {
                        ...
                        if (isValidStatus) {
                            ...
                            const revalidate = ((ref3 = context.staticGenerationContext.store) == null ? void 0 : ref3.revalidate) || false;
