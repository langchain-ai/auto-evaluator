...
const nextFontGoogleFontLoader = async ({ functionName, data, config, emitFontFile, isDev, isServer, }) => {
    var _a;
    const { fontFamily, weights, styles, display, preload, selectedVariableAxes, fallback, adjustFontFallback, variable, subsets, } = (0, validate_google_font_function_call_1.validateGoogleFontFunctionCall)(functionName, data[0], config);
