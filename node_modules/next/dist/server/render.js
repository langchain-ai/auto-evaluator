...
var _reflect = require("./web/spec-extension/adapters/reflect");
...
exports.deserializeErr = deserializeErr;
...
async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    (ref2 = (0, _tracer).getTracer().getRootSpanAttributes()) == null ? void 0 : ref2.set("next.route", renderOpts.pathname);
