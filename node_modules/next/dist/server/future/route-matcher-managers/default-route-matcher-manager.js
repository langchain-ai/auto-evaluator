...
var _localeRouteMatcher = require("../route-matchers/locale-route-matcher");
...
class DefaultRouteMatcherManager {
    ...
    lastCompilationID = this.compilationID;
    /**
   ...
   */ get compilationID() {
    ...
    async reload() {
        ...
        try {
            ...
            for(let index1 = 0; index1 < dynamic.length; index1++){
                // Grab the pathname from the definition.
                const pathname = dynamic[index1].definition.pathname;
   ...
   */ validate(pathname, matcher, options) {
        ...
        if ((ref = options.i18n) == null ? void 0 : ref.inferredFromDefault) {
...
exports.DefaultRouteMatcherManager = DefaultRouteMatcherManager;
