                ...
                binding.referencePaths.forEach((refPath)=>{
                    ...
                    if (propertiesMap.ssr) {
                        ...
                        if (nodePath) {
                            ...
                            if (nonSSR && loader && ((ref2 = state.file.opts.caller) == null ? void 0 : ref2.isServer)) {
                    ...
                    options.node.properties.push(t.objectProperty(t.identifier("loadableGenerated"), t.objectExpression(((ref3 = state.file.opts.caller) == null ? void 0 : ref3.isDev) || ((ref1 = state.file.opts.caller) == null ? void 0 : ref1.isServer) ? [
