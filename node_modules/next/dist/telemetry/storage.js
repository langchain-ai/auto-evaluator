...
var _abortController = require("next/dist/compiled/@edge-runtime/primitives/abort-controller");
...
class Telemetry {
    ...
    flushDetached = (mode, dir)=>{
        const allEvents = [];
        this.queue.forEach((item)=>{
            try {
                var ref;
                (ref = item._controller) == null ? void 0 : ref.abort();
        ...
        (0, _childProcess).spawn(process.execPath, [
