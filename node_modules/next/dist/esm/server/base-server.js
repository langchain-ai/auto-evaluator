...
export default class Server {
    constructor(options){
        ...
        this.localeNormalizer = ((ref = this.nextConfig.i18n) == null ? void 0 : ref.locales) && this.nextConfig.i18n.defaultLocale ? new LocaleRouteNormalizer(this.nextConfig.i18n.locales, this.nextConfig.i18n.defaultLocale) : undefined;
    ...
    getRoutes() {
        ...
        matchers.push(new PagesRouteMatcherProvider(this.distDir, manifestLoader, this.localeNormalizer));
        // Match api routes under `pages/api/`.
        matchers.push(new PagesAPIRouteMatcherProvider(this.distDir, manifestLoader, this.localeNormalizer));
    ...
    async handleRequest(req, res, parsedUrl) {
        return getTracer().trace(BaseServerSpan.handleRequest, async ()=>await this.handleRequestImpl(req, res, parsedUrl));
    }
    ...
    async renderToResponseWithComponentsImpl({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        resolvedUrlPathname = normalizeLocalePath(removeTrailingSlash(resolvedUrlPathname), (ref10 = this.nextConfig.i18n) == null ? void 0 : ref10.locales).pathname;
