import { checkIsOnDemandRevalidate, PRERENDER_REVALIDATE_ONLY_GENERATED_HEADER } from ".";
...
export function tryGetPreviewData(req, res, options) {
    ...
    const previewModeId = (ref = cookies.get(COOKIE_NAME_PRERENDER_BYPASS)) == null ? void 0 : ref.value;
    const tokenPreviewData = (ref1 = cookies.get(COOKIE_NAME_PRERENDER_DATA)) == null ? void 0 : ref1.value;
...
export async function apiResolver(req, res, query, resolverModule, apiContext, propagateError, dev, page) {
    ...
    try {
        ...
        (ref4 = getTracer().getRootSpanAttributes()) == null ? void 0 : ref4.set("next.route", page);
