 ...
 */ export async function clearModuleContext(path, content) {
    ...
    for (const [key2, cache2] of moduleContexts){
        handleContext(key2, cache2, moduleContexts);
    }
    for (const [key1, cache1] of pendingModuleCaches){
        handleContext(key1, await cache1, pendingModuleCaches);
    }
}
