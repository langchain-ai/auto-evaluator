...
export const css = curry(async function css(ctx, config) {
    ...
    const googleLoaderOptions = ((ref2 = (ref = ctx.experimental) == null ? void 0 : (ref1 = ref.fontLoaders) == null ? void 0 : ref1.find((loaderConfig)=>loaderConfig.loader === "@next/font/google" || loaderConfig.loader === "next/font/google")) == null ? void 0 : ref2.options) ?? {};
    const fontLoaders = [
        [
        ...
        fns.push(loader({
            oneOf: [
                markRemovable({
                    ...
                    use: getNextFontLoader(ctx, lazyPostCSSInitializer, fontLoaderPath, fontLoaderOptions)
                }), 
            ]
        }));
    });
