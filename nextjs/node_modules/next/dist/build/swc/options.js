...
function getJestSWCOptions({ isServer , filename , esm , nextConfig , jsConfig , resolvedBaseUrl , pagesDir , hasServerComponents  }) {
...
function getLoaderSWCOptions({ filename , development , isServer , pagesDir , appDir , isPageFile , hasReactRefresh , nextConfig , jsConfig , supportedBrowsers , swcCacheDir , relativeFilePathFromRoot , hasServerComponents , isServerLayer  }) {
    let baseOptions = getBaseSWCOptions({
        filename,
        development,
        globalWindow: !isServer,
