    ...
    return nextExportSpan.traceAsyncFn(async ()=>{
        ...
        if (options.isInvokedFromCli) {
            if (nextConfig.output === "export") {
                Log.warn('"next export" is no longer needed when "output: export" is configured in next.config.js https://nextjs.org/docs/advanced-features/static-html-export');
                return;
            }
