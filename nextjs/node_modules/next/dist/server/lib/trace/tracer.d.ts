...
declare type TracerSpanOptions = Omit<SpanOptions, 'attributes'> & {
    parentSpan?: Span;
    spanName?: string;
...
declare type NextAttributeNames = 'next.route' | 'next.page' | 'next.span_name' | 'next.span_type';
declare type OTELAttributeNames = `http.${string}` | `net.${string}`;
declare type AttributeNames = NextAttributeNames | OTELAttributeNames;
