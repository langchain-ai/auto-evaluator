    ...
    if (isAppDirEnabled) {
        if (userTsConfig.compilerOptions) {
            ...
            const hasNextPlugin = [
                ...
                ...Array.isArray(userTsConfig.compilerOptions.plugins) ? userTsConfig.compilerOptions.plugins : [], 
            ].some(({ name  })=>name === "next");
            ...
            if (!hasNextPlugin && "extends" in userTsConfig && !("plugins" in userTsConfig.compilerOptions)) {
