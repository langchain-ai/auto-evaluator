            ...
            await finishModulesSpan.traceAsyncFn(async ()=>{
                ...
                if (this.turbotrace) {
                    ...
                    if (!(binding == null ? void 0 : binding.isWasm) && typeof binding.turbo.startTrace === "function") {
                        ...
                        const contextDirectory = ((ref4 = this.turbotrace) == null ? void 0 : ref4.contextDirectory) ?? this.tracingRoot;
                        const chunks = [
                            ...entriesToTrace
                        ];
                        this.turbotraceContext.entriesTrace = {
                            action: {
                                ...
                                logLevel: (ref2 = this.turbotrace) == null ? void 0 : ref2.logLevel,
                                showAll: (ref3 = this.turbotrace) == null ? void 0 : ref3.logAll
                            },
                            appDir: this.appDir,
                ...
                if (!(binding == null ? void 0 : binding.isWasm) && typeof binding.turbo.startTrace === "function") {
                    ...
                    this.turbotraceContext.chunksTrace = {
                        action: {
                            ...
                            processCwd: ((ref6 = this.turbotrace) == null ? void 0 : ref6.processCwd) ?? this.appDir,
                            showAll: (ref7 = this.turbotrace) == null ? void 0 : ref7.logAll,
                            logLevel: (ref8 = this.turbotrace) == null ? void 0 : ref8.logLevel
                        },
