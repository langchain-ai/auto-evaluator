...
export type Styles<StylesNames extends string, StylesParams extends Record<string, any> = never> = Partial<Record<StylesNames, CSSObject>> | ((theme: MantineTheme, params: StylesParams, context: ContextStylesParams) => Partial<Record<StylesNames, CSSObject>>);
